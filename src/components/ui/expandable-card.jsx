  ...
  return (
    <>
          ...
          <div
            ...
            <motion.div
              ...
              <motion.div layoutId={`image-${title}-${id}`}>
                <div
                  className="relative before:absolute before:inset-x-0 before:bottom-[-1px] before:z-50 before:h-[70px] before:bg-gradient-to-t before:from-white dark:before:from-zinc-900">
                  <img src={src} alt={title} className="h-80 w-full object-cover object-center" />
                </div>
              </motion.div>
              <div
                className="relative h-full before:fixed before:inset-x-0 before:bottom-0 before:z-50 before:h-[70px] before:bg-gradient-to-t before:from-white dark:before:from-zinc-900">
                <div className="flex h-auto items-start justify-between p-8">
                  ...
                  <motion.button
                    ...
                    className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-gray-200/90 bg-white text-neutral-700 transition-colors duration-300 hover:border-gray-300/90 hover:bg-neutral-50 hover:text-black focus:outline-none dark:border-zinc-800 dark:bg-zinc-900 dark:text-white/70 dark:hover:border-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-white"
      ...
      <motion.div
        ...
        className={cn(
          "flex cursor-pointer flex-col items-start justify-between rounded-2xl border border-gray-200/70 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 dark:shadow-none hover:bg-gray-50 dark:hover:bg-zinc-900/80 transition-colors",
          className
        )}>
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className="flex items-center justify-between w-full">
            ...
            <motion.button
              ...
              layoutId={`button-${title}-${id}`}
              className={cn(
                "flex h-8 w-8 shrink-0 items-center justify-center rounded-full border border-gray-200/90 bg-white text-neutral-700 transition-colors duration-300 hover:border-gray-300/90 hover:bg-neutral-50 hover:text-black focus:outline-none dark:border-zinc-800 dark:bg-zinc-900 dark:text-white/70 dark:hover:border-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-white",
                className
              )}>
              <motion.div animate={{ rotate: active ? 45 : 0 }} transition={{ duration: 0.4 }}>
                <svg
